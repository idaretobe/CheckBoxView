...
public class CheckBoxView extends View implements Checkable {
    ...
    public CheckBoxView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mBackgroundPaintTrue.setColor(context.getResources().getColor(R.color.colorPrimary));
        mBackgroundPaintTrue.setStyle(Paint.Style.FILL);

        mBackgroundPaintFalse = new Paint();
        mBackgroundPaintFalse.setAntiAlias(true);
        mBackgroundPaintFalse.setColor(context.getResources().getColor(R.color.colorGray));
        mBackgroundPaintFalse.setStyle(Paint.Style.FILL);

        mSlidePaint = new Paint();
        mSlidePaint.setAntiAlias(true);
        mSlidePaint.setColor(context.getResources().getColor(R.color.colorAccent));
        mSlidePaint.setStyle(Paint.Style.FILL);

        //初始化属性
        if (attrs != null) {
            TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.CheckBoxView);
            int trueColor = array.getColor(R.styleable.CheckBoxView_trueColor, context.getResources().getColor(R.color.colorPrimary));
            int falseColor = array.getColor(R.styleable.CheckBoxView_falseColor, context.getResources().getColor(R.color.colorGray));
            int slideColor = array.getColor(R.styleable.CheckBoxView_slideColor, context.getResources().getColor(R.color.colorAccent));
